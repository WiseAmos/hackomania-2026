            ...
            >
              ...
              <div className="flex-1 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:border-r border-white/10 sm:pr-6">
                <div className="relative">
                  ...
                  <div className="w-16 h-16 rounded-full bg-slate-900 border border-[#10B981]/30 text-[#10B981] font-[family-name:var(--font-heading)] font-bold flex flex-shrink-0 items-center justify-center text-xl relative z-10">
